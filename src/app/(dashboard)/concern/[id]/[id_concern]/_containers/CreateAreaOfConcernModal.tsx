...
interface CreateAreaOfConcernModalProps {
	isOpen: boolean;
	onClose: () => void;
	concernGroupId: string;
}

export default function CreateAreaOfConcernModal({
	isOpen,
	onClose,
	concernGroupId,
	...
	const mutation = useCreateAreaOfConcernMutation({
		area_of_concern_group_id: concernGroupId,
		onSuccess: () => {
			onClose();
			reset();
